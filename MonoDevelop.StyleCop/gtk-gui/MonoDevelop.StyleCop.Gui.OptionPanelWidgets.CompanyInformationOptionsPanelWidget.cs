...
{
	public partial class CompanyInformationOptionsPanelWidget
	{
		...
		protected virtual void Build()
		{
			...
			// Widget MonoDevelop.StyleCop.Gui.OptionPanelWidgets.CompanyInformationOptionsPanelWidget
			global::Stetic.BinContainer.Attach(this);
			this.WidthRequest = 625;
			this.HeightRequest = 495;
			this.Name = "MonoDevelop.StyleCop.Gui.OptionPanelWidgets.CompanyInformationOptionsPanelWidget";
			// Container child MonoDevelop.StyleCop.Gui.OptionPanelWidgets.CompanyInformationOptionsPanelWidget.Gtk.Container+ContainerChild
