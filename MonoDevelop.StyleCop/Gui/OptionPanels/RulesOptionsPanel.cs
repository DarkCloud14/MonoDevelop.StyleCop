...
namespace MonoDevelop.StyleCop.Gui.OptionPanels
{
  ...
  /// </summary>
  internal class RulesOptionsPanel : StyleCopOptionsPanel
  {
    #region Private Fields

    /// <summary>
    /// The rules options panel widget.
    /// </summary>
    private RulesOptionsPanelWidget widget = new RulesOptionsPanelWidget();
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="MonoDevelop.StyleCop.Gui.OptionPanels.RulesOptionsPanel"/> class.
    /// </summary>
    internal RulesOptionsPanel()
    {
    }
