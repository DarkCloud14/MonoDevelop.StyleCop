...
namespace MonoDevelop.StyleCop.Gui.OptionPanels
{
  ...
  /// </summary>
  internal class CompanyInformationOptionsPanel : StyleCopOptionsPanel
  {
    #region Private Fields

    /// <summary>
    /// The company information options panel widget.
    /// </summary>
    private CompanyInformationOptionsPanelWidget widget = new CompanyInformationOptionsPanelWidget();
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="MonoDevelop.StyleCop.Gui.OptionPanels.CompanyInformationOptionsPanel"/> class.
    /// </summary>
    internal CompanyInformationOptionsPanel()
    {
    }
